...
[roundNeurons2,km3Filt] =kmeans3Fnc(blobfilt,roundNeurons,xy,res,folder);
roundNeurons =roundNeurons2;
kMeanOut = struct('idx',idx,'C',C,'kData',kData,'distThresh',distThresh,'RoundNeurons',roundNeurons,'PyramidalNeurons',pyramidalNeurons,'km3Filt',km3Filt);
clear idx kData distThresh km3Filt
...
function [roundNeurons,km3Filt] =kmeans3Fnc(blobfilt,roundNeurons,xy,res,folder)
...
% Outputs:
%     roundNeurons,     Detected round neurons
%     km3Filt,          Total number of removed objects
